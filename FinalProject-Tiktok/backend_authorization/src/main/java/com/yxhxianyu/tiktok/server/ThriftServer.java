package com.yxhxianyu.tiktok.server;

import com.yxhxianyu.tiktok.dto.AuthorizationServiceDTO;
import com.yxhxianyu.tiktok.impl.AuthorizationServiceImpl;
...
public class ThriftServer {
    ...
    public void start() {
        try {
            ...
            //添加业务
            AuthorizationServiceDTO.Processor<AuthorizationServiceImpl> processor = new AuthorizationServiceDTO.Processor<>(authorizationService);
